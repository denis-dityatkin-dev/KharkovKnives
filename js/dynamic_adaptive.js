...
// Прячем поиск в catalog-header__container=========================================================
//Объявляем переменные
const parent_original2 = document.querySelector(".body-header");
const parent2 = document.querySelector(".catalog-header__container");
const item4 = document.querySelector(".body-header__search");
// const item4 = document.querySelector(".search-header");
...
function move2(){
	...
	if (viewport_width <= 479.98) {
    if (!item4.classList.contains("done")) {
      parent2.insertBefore(item4, parent2.children[2]);
      item4.classList.add("done");
    }
  } else {
    if (item4.classList.contains("done")) {
      parent_original2.insertBefore(item4, parent_original2.children[2]);
